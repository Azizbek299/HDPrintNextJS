...
const Products = () => {
  ...
  async function deleteProduct(id: string, imageURL: string) {
    ...
    await DeleteProduct(idAndUrlForDelete.id);

    setProductData(productData.filter((item:any)=> item._id !== id))
      ...
      <div className="">
        <div className="w-80% bg-white mx-auto py-20">
          ...
          <div className=" w-70% mx-auto flex justify-around mt-70 mb-30">
            <button
              onClick={() =>
                deleteProduct(idAndUrlForDelete.id, idAndUrlForDelete.url)
              }
